...
public final class JavmosGUI {
    ...
    private final JFrame frame = new JFrame("Javmos v1123.0");
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(firstDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, new Color(220, 20, 60));
        configureComponent(secondDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, Color.CYAN);
